...
def CreateFirstWindow():  # This is the window that would be displayed if the user is newly using the Application
    FirstWindow = Tk()
    ...
    Label(FirstWindow, text="Create Admin Account", font=Font1, relief=SOLID, bg=LoginPageTheme1, bd=4,
          fg=LoginPageTheme2).place(x=-3, y=0)
    Label(FirstWindow, text="Username: ", font=Font2, bg=LoginPageTheme1, fg=LoginPageTheme2).place(x=55, y=140)
    Label(FirstWindow, text="Password: ", font=Font2, bg=LoginPageTheme1, fg=LoginPageTheme2).place(x=55, y=220)
    UsernameEntry = Entry(FirstWindow, relief=SOLID, font=Font3, bd=2, bg=LoginEntryTheme)
    UsernameEntry.place(x=255, y=145)
    PasswordEntry = Entry(FirstWindow, relief=SOLID, font=Font3, bd=2, show="*", bg=LoginEntryTheme)
    PasswordEntry.place(x=255, y=225)
    ...
    ShowPasswordButton.place(x=240, y=300)
    ...
    CreateButton.place(x=235, y=350)
...
def CreateLoginWindow():
    ...
    xCoordinate = int(screen_width / 2 - window_width / 2)
    yCoordinate = int(screen_height / 2 - window_height / 2)
    LoginWindow.geometry(f'{window_width}x{window_height}+{xCoordinate}+{yCoordinate}')
    ...
    Label(LoginWindow, text="Login Portal", font=Font1, relief=SOLID, bg=LoginPageTheme1, bd=4, anchor=CENTER, width=18,
          fg=LoginPageTheme2).place(x=-12, y=0)
    Label(LoginWindow, text="Username: ", font=Font2, bg=LoginPageTheme1, fg=LoginPageTheme2).place(x=60, y=140)
    Label(LoginWindow, text="Password: ", font=Font2, bg=LoginPageTheme1, fg=LoginPageTheme2).place(x=60, y=220)
    UsernameEntry = Entry(LoginWindow, relief=SOLID, font=Font3, bd=2, bg=LoginEntryTheme)
    UsernameEntry.place(x=260, y=145)
    PasswordEntry = Entry(LoginWindow, relief=SOLID, font=Font3, bd=2, show="*", bg=LoginEntryTheme)
    PasswordEntry.place(x=260, y=225)
    ShowPasswordVar = IntVar()
    ...
    StaySignedInButton.place(x=240, y=340)
    ...
    AddNewUserBtn.place(x=310, y=400)
...
def BillingFrameWidgets(window_name):
    ...
    TotalLabel = Label(TotalHolder, text="0", font=Font1, bg=BillingFrameTheme)
    ...
    if len(current_bill) > 0:
        ...
        CreateFinalBillButton = Button(BillWindow, text="Create", font=Font5, bg=LoginPageTheme1,
                                       ...
                                       command=lambda: CreateFinalBillButtonFunction(BillWindow,
                                                                                     ...
                                                                                     TreeviewName, LabelName))
        CreateFinalBillButton.place(x=182, y=150)
    else:
        messagebox.showerror("Bill", "Bill cannot be empty")


def CreateFinalBillButtonFunction(window_name, name, TreeviewName, LabelName):
    if name == "":
        ...
        LabelName['text'] = str(Grand_Total)
